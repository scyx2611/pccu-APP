              ...
              <View style={styles.courseRow}>
                <View style={styles.courseLeft}>
                  ...
                  <View style={styles.courseTags}>
                    {!!course.type && (
                      <Text style={[styles.tag, { backgroundColor: theme.border, color: theme.textSub }]}>
                        {course.type}
                      </Text>
                    )}
                    <Text style={[styles.tag, { backgroundColor: theme.border, color: theme.textSub }]}
                ...
                <View style={styles.courseRight}>
                  <Text
                    style={[styles.scoreText, { color: isFailScore(course.score) ? theme.danger : theme.text }]}
                  >
                    {course.score || '--'}
                  </Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  courseRow: { flexDirection: 'row', alignItems: 'center', padding: 16, justifyContent: 'space-between' },
